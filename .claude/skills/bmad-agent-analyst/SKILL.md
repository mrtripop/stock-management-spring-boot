...
- All skills use sonnet for balanced analysis and discovery work
...
When orchestrating analysis phase:
1. Spawn Market Research subagent (sonnet) to analyze competition
2. Spawn Domain Research subagent (sonnet) to deep-dive industry
3. Spawn Technical Research subagent (sonnet) to assess feasibility
4. All run in parallel via multiple Agent calls
5. Collect and synthesize findings into unified analysis
