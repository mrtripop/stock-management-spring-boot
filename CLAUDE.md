...
This project is indexed by GitNexus as **stock-management-spring-boot** (9875 symbols, 22083 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
