...
**Files:**
- Rewrite: `demo-ui/src/pages/Products.jsx`

- [ ] **Step 1: Rewrite Products.jsx with new components**

Replace `demo-ui/src/pages/Products.jsx`:
...
Navigate to `/products` after login. Expected: Search bar, data table with pagination, "Add Product" button opens drawer, delete shows confirmation.

- [ ] **Step 3: Commit**

```bash
git add demo-ui/src/pages/Products.jsx
git commit -m "feat(demo-ui): redesign Products page with DataTable and FormDrawer

Full CRUD using React Query mutations with toast notifications.
DataTable with search, pagination, edit/delete actions per row.
FormDrawer for create/edit, AlertDialog for delete confirmation."
```
