...
**Files:**
- Rewrite: `demo-ui/src/pages/Inventory.jsx`

- [ ] **Step 1: Rewrite Inventory.jsx**

Replace `demo-ui/src/pages/Inventory.jsx`:
...
Navigate to `/inventory`. Expected: Batch table with expiry color-coding (red/amber rows), Stock In and Deduct drawers.

- [ ] **Step 3: Commit**

```bash
git add demo-ui/src/pages/Inventory.jsx
git commit -m "feat(demo-ui): redesign Inventory page with batch expiry highlighting

Color-coded expiry rows (red <7d, amber <30d) with day-count badges.
Stock In and Deduct operations via FormDrawer with React Query mutations.
